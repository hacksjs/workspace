...
# ==============================================================================
# Bash script to automatically clone all Hacks.js project repositories.
#
# Usage instructions:
#
# 1. Create an empty directory to encapsulate all the Hacks.js projects.
# 2. Change to the project directory and clone the `hacksjs/workspace` repo
...
# Absolute path to the user's root directory for the Hacks.js project,
